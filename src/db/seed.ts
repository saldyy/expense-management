...
const DEFAULT_CATEGORIES: Array<Omit<NewCategory, 'createdAt' | 'updatedAt' | 'id'>> = [
  { name: 'categories.food', icon: '🍜', color: '#FF9F0A', kind: 'expense', sortOrder: 10, isDefault: true },
  { name: 'categories.transport', icon: '🚌', color: '#0A84FF', kind: 'expense', sortOrder: 20, isDefault: true },
  { name: 'categories.housing', icon: '🏠', color: '#5E5CE6', kind: 'expense', sortOrder: 30, isDefault: true },
  { name: 'categories.shopping', icon: '🛍️', color: '#FF375F', kind: 'expense', sortOrder: 40, isDefault: true },
  { name: 'categories.health', icon: '💊', color: '#30D158', kind: 'expense', sortOrder: 50, isDefault: true },
  { name: 'categories.entertainment', icon: '🎬', color: '#BF5AF2', kind: 'expense', sortOrder: 60, isDefault: true },
  { name: 'categories.other', icon: '💸', color: '#8E8E93', kind: 'expense', sortOrder: 70, isDefault: true },
  { name: 'categories.salary', icon: '💼', color: '#30D158', kind: 'income', sortOrder: 10, isDefault: true },
  { name: 'categories.gift', icon: '🎁', color: '#FF9F0A', kind: 'income', sortOrder: 20, isDefault: true },
];
